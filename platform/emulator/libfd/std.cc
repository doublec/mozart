...
OZ_Term Propagator_D_D_D_I::getParametersC(char const * lit) const
{
...
OZ_Term Propagator_D_D_I::getParametersC(char const * lit) const
{
...
OZ_Term Propagator_VI_VD_I::getParametersC(char const * lit) const
{
...
OZ_Term Propagator_VI_VD_I_D::getParametersC(char const * lit) const
{
  INTVECTOR2LIST(reg_a, reg_sz, a);
  TERMVECTOR2LIST(reg_x, reg_sz, x);
...
OZ_Term Propagator_VI_VVD_I::getParametersC(char const * lit) const
{
  INTVECTOR2LIST(reg_a, reg_sz, a);
...
OZ_Term Propagator_VI_VD_D::getParametersC(char const *lit) const
{
  INTVECTOR2LIST(reg_a, reg_sz, a);
  TERMVECTOR2LIST(reg_x, reg_sz, x);

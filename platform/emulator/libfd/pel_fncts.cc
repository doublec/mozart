...
template class _OZ_ParamIterator<uintptr_t>;
template class _PropagatorController_V_V<uintptr_t, PEL_FDIntVar, 1, 0, 2>;
template class _PropagatorController_V_V_V<uintptr_t, OZ_FDIntVar, 1, 0, 3>;
